...
const Performance = () => {
  return (
    <section className="py-24 md:py-32 bg-white text-[#1d1d1f] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 mb-24">
          <div className="w-full lg:w-1/2">
            ...
            >
              Chip M4. <br />
              <span className="text-[#86868b]">Una potencia que fluye.</span>
            </motion.h2>
            <p className="text-xl text-[#1d1d1f] mb-12 leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <motion.div 
                  ...
                  className="bg-[#f5f5f7] p-6 rounded-3xl border border-white/50 hover:shadow-lg transition-all duration-300"
                >
                    <Brain className="w-8 h-8 text-purple-500 mb-4" />
                    <h4 className="text-lg font-semibold mb-2">Apple Intelligence</h4>
                    <p className="text-sm text-[#86868b] font-medium">Diseñado para la IA desde el silicio. Personal, privado, potente.</p>
                </motion.div>
                <motion.div 
                  whileHover={{ scale: 1.02 }}
                  className="bg-[#f5f5f7] p-6 rounded-3xl border border-white/50 hover:shadow-lg transition-all duration-300"
                >
                    ...
                    <p className="text-sm text-[#86868b] font-medium">Hasta 18 horas de autonomía. Olvídate del enchufe.</p>
                </motion.div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 space-y-12">
            ...
            <div>
              <div className="flex justify-between text-sm font-medium text-[#86868b] mb-2">
                ...
                <span className="text-[#1d1d1f]">1.5x Más Rápido</span>
              </div>
