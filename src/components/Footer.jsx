...
const Footer = () => {
  return (
    <footer className="bg-[#f5f5f7] text-[#86868b] py-12 border-t border-gray-200 text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h4 className="text-[#1d1d1f] font-semibold mb-4">Descubrir y Comprar</h4>
          ...
          <div>
            <h4 className="text-[#1d1d1f] font-semibold mb-4">Cuenta</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="text-[#1d1d1f] font-semibold mb-4">Apple Store</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="text-[#1d1d1f] font-semibold mb-4">Acerca de Apple</h4>
            <ul className="space-y-2">
